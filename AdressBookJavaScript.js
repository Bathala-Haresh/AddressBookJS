class Contact {
  ...
  function Main() {
    ...
    AddressBook.filter(
      (contact) =>
        contact.firstName == "Haresh" && contact.phoneNumber == "91 8247614883"
    ).forEach((contact) => {
    ...
    DeleteContact("Joe", "91 7654321098");
    AddressBook.forEach((contact) => console.log(contact.toString()));
    // UC8 Prints Contact by city.
    console.log(SearchByCity("Srikakulam"));
    // UC8 Prints Contact by state.
    console.log(SearchByState("Kolkatta"));
